    ...
    return (
      <div className="navbar">
        ...
        <div className="header_title">
          <h4 className="header_title_hover">Discover</h4>
          <h4 className="header_title_hover">Livestreams</h4>
          <h4 className="header_title_hover">Jobs</h4>
        </div>
        <div className="search">
          <input className="search_input" placeholder="Search"></input>
        </div>
        <div className="navbar_left_title">
          <button id="navbar_login" onClick={
            () =>{
              history.push("/login")
            }
          }>Log in</button>
          <button id="navbar_signup" onClick={
            () =>{
              history.push("./signup")
            }
          }>Sign Up</button>
        </div>
        <div id="adobe-img_container">
          <svg
